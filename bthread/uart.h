...
#define UARTDR (MMIO_UART_0+0x0000)
#define UARTRSR (MMIO_UART_0+0x0004)
#define UARTFR (MMIO_UART_0+0x0018)
#define UARTILPR (MMIO_UART_0+0x0020)
#define UARTIBRD (MMIO_UART_0+0x0024)
#define UARTFBRD (MMIO_UART_0+0x0028)
#define UARTLCRH (MMIO_UART_0+0x002c)
#define UARTCR (MMIO_UART_0+0x0030)
#define UARTIFLS (MMIO_UART_0+0x0034)
#define UARTIMSC (MMIO_UART_0+0x0038)
#define UARTRIS (MMIO_UART_0+0x003c)
#define UARTMIS (MMIO_UART_0+0x0040)
#define UARTICR (MMIO_UART_0+0x0044)
#define UARTDMACR (MMIO_UART_0+0x0048)
